;Integrate an irradiance or uncertainty from wave_min to wave_max, using an arbitrary
;wavelength scale
;input
...
;  wave       - center wavelength of each bin of the irradiance
...
function eve_integrate_line_wave,wave_min,wave_max,irradiance_in,wave,unc=unc,neg=neg
